...
conversation_history = [
    {
        ...
        "content": (
            ...
            "  'age', 'over 18', 'over18', 'just age', 'profile', 'my profile', 'only my profile info'), "
            ...
            "  selection of that option. Do NOT ask again which option they want.\n"
            ...
            "- When you respond, restate it once (e.g., 'I will use thierry@altme.io for this check') "
            "  so it is clear which email you are using.\n"
            ...
            "- When you call 'start_user_verification', always use the stored email value for "
            "  'user_email'.\n\n"
