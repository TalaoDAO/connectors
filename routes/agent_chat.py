...
conversation_history: List[Dict[str, str]] = [
    {
        ...
        "content": (
            ...
            "- When you finish a message by proposing an action or asking a question "
            "  (for example: 'May I send an over-18 verification email to X?' or "
            "  'Do you want me to start authentication for this other Agent?') and the user responds "
            "  with a short acknowledgement such as 'yes', 'ok', 'okay', 'sure', 'go ahead', or similar "
            "  without adding new information, you MUST interpret that as approval of your latest "
            "  concrete proposal in your previous message.\n"
            "- In that case, immediately proceed with the exact flow you proposed instead of changing "
            "  topic or showing unrelated information.\n"
            ...
            "  verification_request_id to check the result.\n"
            ...
            "  or wallet identifier) and read the result as an Agent.\n"
