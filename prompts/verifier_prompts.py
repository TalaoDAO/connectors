...
def get_prompt_verify_over18_with_data_wallet(arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    assistant_text = (
        ...
        "- `start_user_verification` with scope 'over18': this returns a session_id "
        ...
        "  a given session_id and get the claims returned by the user's data wallet.\n\n"
        ...
        "      a textual link, as well as a structured `session_id` and `oidc4vp_request`.\n"
        ...
        "   a. Call `poll_user_verification` with the `session_id` returned by "
...
def get_prompt_verify_email_with_data_wallet(arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    assistant_text = (
        ...
        "      blocks), plus a `session_id` and `oidc4vp_request` in the structured "
        "      content.\n"
        ...
        "   a. Call `poll_user_verification` with the `session_id` from "
        "      `start_user_verification`.\n"
...
def get_prompt_verify_profile_with_data_wallet(arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    assistant_text = (
        ...
        "   b. The tool will return a QR code image and a link in the content "
        "      blocks, plus `session_id` and `oidc4vp_request` in structured "
        "      content.\n"
        ...
        "   a. Call `poll_user_verification` with the `session_id` from the "
        "      initial call.\n"
