...
def get_prompt_learn_wallet4agent(arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    system_text = (
        ...
        "   - Which main tools are available for agents "
        "     (accepting credentials, listing attestations, resolving other agents).\n"
...
def get_prompt_inspect_this_agent_wallet(arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    system_text = (
        ...
        "  agent_identifier (DID), wallet URL, number of attestations, and "
        "  whether a human is always kept in the loop.\n"
        "- `get_attestations_of_this_wallet`: returns all attestations "
        "  (verifiable credentials) currently stored in the wallet.\n\n"
        "Your workflow:\n"
        ...
        "   - Identify the agent_identifier (DID) and wallet URL.\n"
        "   - Indicate whether a human is always in the loop.\n"
        "   - Summarize the number and main types of attestations "
        "     (e.g., AgentCards, delegations, organization membership).\n"
    ...
    user_text = (
        "Inspect this Agent's wallet and summarize its metadata and stored "
        "attestations for me."
    )
